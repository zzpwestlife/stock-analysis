...
- **价格趋势分析**：确定市场走势方向和强度
- **布林带（Bollinger Bands）分析**：判断价格波动范围和潜在变盘点
...
确保您的系统已安装 Python 3.6 或更高版本。为了避免与系统 Python 环境冲突，建议使用虚拟环境：
...
布林带由三条轨道线组成：中轨（移动平均线）、上轨和下轨（中轨加减标准差）。
...
**应用场景**：
- **超买/超卖**：价格突破上轨可能超买；跌破下轨可能超卖
- **趋势反转**：布林带收口（带宽变窄）通常预示着剧烈的价格波动即将到来
- **支撑/阻力**：上轨和下轨通常作为动态的阻力和支撑位

### 4. MACD（移动平均汇聚/发散）

MACD 是通过比较两条移动平均线的差值来显示价格动量变化的技术指标。
